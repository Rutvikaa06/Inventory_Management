...
class BillClass:
    def __init__(self,root):
        ...
        self.root.title("Inventory System | Developed By SRUTHY And RUTVIKA")
        ...
        title=Label(self.root,text="Inventory System",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),bg="#010c48",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70) #====button logout====
        ...
        #===clock===
        self.lbl_clock=Label(self.root,text="Welcome to Inventory System\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("times new roman",15),bg="#4d636d",fg="white")
        ...
        self.txt_cal_input=Entry(Cal_Frame,textvariable=self.var_cal_input,font=('arial',15,'bold'),width=21,bd=9,relief=GROOVE,state='readonly',justify=RIGHT)
        ...
        tet_p_name=Entry(Add_CartWidgetsFrame,textvariable=self.var_pname,font=("times new roman",15),bg="lightyellow",state='readonly').place(x=5,y=35,width=190,height=22)

        lbl_p_price=Label(Add_CartWidgetsFrame,text="Price Per Qty",font=("times new roman",15),bg="white").place(x=230,y=5)
        tet_p_price=Entry(Add_CartWidgetsFrame,textvariable=self.var_price,font=("times new roman",15),bg="lightyellow",state='readonly').place(x=230,y=35,width=150,height=22)

        lbl_p_qty=Label(Add_CartWidgetsFrame,text="Quantity",font=("times new roman",15),bg="white").place(x=390,y=5)
        tet_p_qty=Entry(Add_CartWidgetsFrame,textvariable=self.var_qty,font=("times new roman",15),bg="lightyellow").place(x=390,y=35,width=120,height=22)
        ...
        #================Footer==========================
        footer=Label(self.root,text="IS-Inventory System | Developed By SRUTHY And RUTVIKA\nFor any Technical Issue contact: 981xxxxx71",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
    ...
    def generate_bill(self):
        if self.var_cname.get()=='' or self.var_contact.get()=='':
            ...
            fp.close()
            messagebox.showinfo('Saved',"Bill has been generated/Save inn Backend",parent=self.root)
            self.chk_print=1
...
{str("="*47)}\n
    ...
    def update_date_time(self):
        ...
        self.lbl_clock.config(text=f"Welcome to Inventory System\t\t Date: {str(date_)}\t\t Time: {str(time_)}")
