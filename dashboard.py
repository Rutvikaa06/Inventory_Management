...
class IMS:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Inventory System",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),bg="#010c48",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        ...
        btn_exit=Button(LeftMenu,text="Exit",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2",command=self.exit_).pack(side=TOP,fill=X) 
        ...
        #===footer===
        lbl_footer=Label(self.root,text="IS-Inventory System | Developed By Sruthy And Rutvika\nFor any Technical Issue Contact: 9881xxxx71",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
